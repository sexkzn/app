...
function BodiesPage() {
  ...
  return [
    <Seo
      title={`Проститутки Индивидуалки Шлюхи Казань`}
      description={`Каталог лучших проституток и индивидуалок Казани. Лучшие секс и интим услуги в Казани, фотографии проверены.`}
    />,
                ...
                <NavLink className="no-decoration" to={`/girl/${item.id}`}>
                  <Card>
                    ...
                    <CardBody>
                      ...
                      <CardSubtitle className="mb-2 blured-text">
                        {item.phoneNumber}
                      </CardSubtitle>
                      <CardText>
                        ...
                        <div>
                          <strong>Цена за час: {item.priceInOne} см</strong>
                        </div>
                        <div>
                          <strong>Цена за 2 часa: {item.priceInTwo} см</strong>
                        </div>
                        <div>
                          <strong>Цена за ночь: {item.priceInNight} см</strong>
                        </div>
                      </CardText>
